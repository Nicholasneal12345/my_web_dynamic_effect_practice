    ...
    for(let i = 0; i < accordion_title.length; i = i + 1){
        ...
        accordion_title[i].addEventListener("click", function(){
            ...
            if(this.nextElementSibling.classList.contains("open")){
                this.nextElementSibling.style.height = `${this.nextElementSibling.children[0].offsetHeight}px`;console.log(this.nextElementSibling, this.nextElementSibling.children[0].offsetHeight);
            }else{
